...
class $HabitsTable extends Habits with TableInfo<$HabitsTable, Habit> {
  ...
  static const VerificationMeta _totalCompletionMeta = const VerificationMeta(
    'totalCompletion',
  );
  @override
  ...
  Habit map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Habit(
      ...
      totalCompletion: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}total_completion'],
      )!,
